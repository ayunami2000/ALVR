...
Follow the Basic-Basic-Basic-installation guide [here](https://github.com/alvr-org/ALVR/wiki/Basic-Basic-Basic-installation).
...
Open `ALVR Launcher.exe`, go to `Basic-Basic-Basic-installation` tab then press `Remove firewall rules`. Close ALVR window and delete the ALVR folder.

If you have a version prior to v12.0 you need to launch `remove_firewall_rules.bat` and `driver_uninstall.bat` in the Basic-Basic-Basic-installation folder.
